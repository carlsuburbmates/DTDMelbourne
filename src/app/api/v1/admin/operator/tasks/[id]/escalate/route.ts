// ============================================================================
// DTD Phase 5: Operations - Operator Task Escalate API
// File: src/app/api/v1/admin/operator/tasks/[id]/escalate/route.ts
// Description: Escalate operator task
// ============================================================================
...
export async function POST(
  ...
  try {
    ...
    const task = await workflowService.escalateTask(id, body.reason);
    ...
    logError(error, { method: 'POST', path: '/api/v1/admin/operator/tasks/[id]/escalate' });
