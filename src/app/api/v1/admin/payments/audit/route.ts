// ============================================================================
// DTD Phase 2: API Contract - Get Payment Audit Log
// File: src/app/api/v1/admin/payments/audit/route.ts
// Description: Get payment audit log
// ============================================================================

import { NextRequest, NextResponse } from 'next/server';
import { supabase, verifyAccessToken, isAdmin } from '@/lib/auth';
import {
  paymentAuditQuerySchema,
  validateQueryParams,
} from '@/lib/validation';
import {
  handleSupabaseError,
...
import type { PaymentAuditQuery } from '@/types/api';

/**
 * GET /api/v1/admin/payments/audit - Get payment audit log
 */
export async function GET(request: NextRequest) {
  try {
    ...
    if (validatedParams.business_id) {
      query = query.eq('business_id', validatedParams.business_id);
    }
    ...
    return NextResponse.json(
      formatErrorResponse(apiError as any, apiError.message || 'Failed to get payment audit log'),
      {
