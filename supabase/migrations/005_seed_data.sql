...
INSERT INTO businesses (
  name, resource_type, locality_id, council_id,
  phone, email, website, description,
  age_specialties, behavior_issues, service_type_primary, service_type_secondary,
  verified, claimed, scaffolded, data_source
) VALUES (
  'Loose Lead Training', 'trainer', 13, 3,
  '+61 3 9876 5432', 'alice@looseleadtraining.com', 'https://looseleadtraining.com.au',
  'Certified dog trainer with 10 years experience specializing in positive reinforcement methods.',
  ARRAY['Puppy (0–6 months)', 'Adult (1.5–7 years)'],
  ARRAY['Pulling on the lead', 'Separation anxiety'],
  'Obedience training',
  ARRAY['Private training', 'Group classes'],
  FALSE, FALSE, TRUE, 'manual_form'
);
...
INSERT INTO businesses (
  ...
  'Happy Paws Training', 'trainer', 10, 10,
  '+61 3 9123 4567', 'info@happypawstraining.com', 'https://happypawstraining.com.au',
  'Professional dog training services for all breeds and ages. We use science-based methods.',
  ARRAY['Puppy (0–6 months)', 'Adolescent (6–18 months)', 'Any age'],
  ARRAY['Jumping up on people', 'Recall issues', 'Socialisation'],
  'Puppy training',
  ARRAY['Group classes'],
  FALSE, FALSE, TRUE, 'manual_form'
);
...
INSERT INTO businesses (
  ...
  'MASH Ringwood', 'emergency_vet', 13, 13,
  '+61 3 9876 5600', 'emergency@mashringwood.com.au', 'https://mashringwood.com.au',
